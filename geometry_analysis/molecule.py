...
from .measure import calculate_angle, calculate_distance #import * implies all function from measure are imported 
...
if __name__ == "__main__":
    ...
    print(F'The new number of bonds are {len(my_molecule.bonds)}')
